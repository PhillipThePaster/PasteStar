...
namespace ESPConfig
{
	...
	inline int BoxFillType = 0; // 0: Flat | 1: Multicolor
	inline int HeadBoxStyle = 0; // 0: Unfilled | 1: Filled
	inline float BoxAlpha = 0.35f;
	inline bool ShowLineToEnemy = false;
	inline int RenderDistance = 0;
	
	inline int LinePos = 2;// 0: Top 1: Center 2: Bottom
	...
	inline ImColor FilledVisColor = ImColor(0, 255, 0, 255);
