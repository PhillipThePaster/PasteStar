			...
			case 2:
				...
				ImGui::BeginChild("Tab1", ImVec2(235, 382));
				{
					...
					ImGui::BeginGroup(); {
						...
						ImGui::SameLine();
						ImGui::ColorEdit4("##boxviscolor", reinterpret_cast<float*>(&ESPConfig::VisibleColor), ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaBar);
						ImGui::SameLine();
						...
						if (ImGui::IsItemClicked(1)) {
							ImGui::OpenPopup("##FBset");
						}
						if (ImGui::BeginPopup("##FBset")) {
							ImGui::SetNextItemWidth(120.f);
							ImGui::Combo("##fillbox", &ESPConfig::BoxFillType, "Filled\0Gradient\0");
							ImGui::EndPopup();
						}
						if (ImGui::IsItemHovered())	ImGui::SetTooltip("RightClick for more Options");
						ImGui::SameLine();
						ImGui::ColorEdit4("##Filledviscolor", reinterpret_cast<float*>(&ESPConfig::FilledVisColor), ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaBar);
						ImGui::SameLine();
						...
						ImGui::SameLine();
						ImGui::ColorEdit4("##Healthbarcolor", reinterpret_cast<float*>(&ESPConfig::HealthbarMax), ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaBar);
						ImGui::Checkbox("Armourbar", &ESPConfig::ArmorBar);
						ImGui::SameLine();
						ImGui::ColorEdit4("##ArmourBarcolor", reinterpret_cast<float*>(&ESPConfig::ArmourColor), ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaBar);
						ImGui::Checkbox("Ammobar", &ESPConfig::AmmoBar);
						ImGui::SameLine();
						ImGui::ColorEdit4("##AmmoBarcolor", reinterpret_cast<float*>(&ESPConfig::AmmoColor), ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaBar);
				...
				ImGui::BeginChild("Tab2", ImVec2(235, 382));
				{
					...
					ImGui::BeginGroup(); {
						...
						ImGui::Checkbox("CrossHair", &CrosshairsCFG::ShowCrossHair);
						if (ImGui::IsItemClicked(1)) ImGui::OpenPopup("##Settings");
						if (ImGui::BeginPopup("##Settings")) {
							ImGui::TextUnformatted("Settings");
							ImGui::Checkbox("Center Dot", &CrosshairsCFG::drawDot);
							if (CrosshairsCFG::drawDot)
								ImGui::SliderFloat("Dot Size", &CrosshairsCFG::DotSize, 1.f, 50.f, "%.f");
							ImGui::SliderInt("Horizontal Length", &CrosshairsCFG::HorizontalLength, 0, 75, "%d");
							ImGui::SliderInt("Vertical Length", &CrosshairsCFG::VerticalLength, 0, 75, "%d");
							ImGui::SliderInt("Thickness", &CrosshairsCFG::Thickness, 1, 20, "%d");
							ImGui::SliderInt("Gap", &CrosshairsCFG::Gap, 0, 35, "%d");
							ImGui::Checkbox("Outline", &CrosshairsCFG::drawOutLine);
							ImGui::Checkbox("T Style", &CrosshairsCFG::tStyle);
							ImGui::Checkbox("Circle", &CrosshairsCFG::drawCircle);
							if (CrosshairsCFG::drawCircle)
								ImGui::SliderFloat("Circle Radius", &CrosshairsCFG::CircleRadius, 1.f, 50.f, "%.f");
							ImGui::Checkbox("Targeting", &CrosshairsCFG::Targeting);
							ImGui::SameLine();
							ImGui::ColorEdit4("##TargetingCol", reinterpret_cast<float*>(&CrosshairsCFG::TargetedColor), ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaBar);
							if (CrosshairsCFG::Targeting)
								ImGui::Checkbox("Team Check", &CrosshairsCFG::TeamCheck);
							ImGui::EndPopup();
						}
						if (ImGui::IsItemHovered())	ImGui::SetTooltip("RightClick for more Options");
